...
% returnSumDiffProductMax function willtake 2 varaibles inputed in the 
% command window following the function returnSumDiffProductMax in the 
% form of (x,x) the function will give thesum, product, difference, 
% and max of the inputed numbers as outputs. 
